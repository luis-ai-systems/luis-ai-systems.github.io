...
我的 Windows Terminal 文件见 <https://github.com/luis-ai-systems/config-files/blob/master/windows-terminal-profiles.json>
...
我的 PowerShell 配置见 <https://github.com/luis-ai-systems/config-files/blob/master/powershell.ps1>
