...
本文主要记录 Android Studio 的使用技巧等，使用过程中遇到的问题详见我的另一篇博客 [Android Studio 遇到问题集锦](https://luis-ai-systems.github.io/luis-ai-system.github.io/2015/05/06/android-studio/)。
